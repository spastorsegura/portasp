      ...
      <div className="container mx-auto px-4 md:px-8 grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Hola, soy <br />
            <span className="text-gradient">Sergio Pastor</span>
          </h1>
          <p className="text-xl text-slate-400 mb-8 max-w-lg leading-relaxed">
            Frontend Developer apasionado por construir experiencias web
            modernas, limpias e interactivas utilizando , y tecnologías frontend
            actuales.{" "}
            <span className="text-violet-400 font-semibold">React,</span>{" "}
          ...
          <div className="flex flex-wrap gap-4 mb-10">
            <Link
              ...
              smooth={true}
              offset={-100}
              className="px-8 py-3 bg-violet-600 hover:bg-violet-700 text-white rounded-lg font-medium transition-all shadow-lg shadow-violet-600/20 cursor-pointer"
            >
              Ver trabajos
            </Link>
            <a
          ...
          <div className="w-full h-[500px] border border-slate-800 bg-slate-900/50 rounded-2xl relative overflow-hidden group">
            ...
            <div className="p-6 font-mono text-sm space-y-4 text-slate-400">
              ...
              <div className="pl-6">
                ...
                <span className="text-green-400">'Sergio Pastor'</span>,
              </div>
              <div className="pl-6">
              ...
              <div className="pl-6">
                ...
                <span className="text-yellow-400">
                  ...
                  Js','TypeScript', 'TailwindCSS', 'MongoDB', 'PostgreSQL']
                </span>
                ,
              </div>
              <div className="pl-6">
                <span className="text-slate-500">interes:</span>{" "}
                <span className="text-green-400">
                  'Explorando constantemente nuevas tecnologías frontend y
